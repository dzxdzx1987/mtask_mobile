...
public class TaskDetailFragment extends Fragment {
    ...
    public static TaskDetailFragment newInstance(List<Integer> colors, int position) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.task_detail_item_page, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView tvTitle = view.findViewById(R.id.task_content_text);
